                ...
                <ul
                    ...
                    <li>
                        <a class="transition-all text-gray-900 hover:text-primary dark:text-white dark:hover:text-primary"
                            href="_str2-account-info.html">Personal Info</a>
                    </li>
                    ...
                    <li>
                        <a class="transition-all text-gray-900 hover:text-primary dark:text-white dark:hover:text-primary"
                            href="_str2-account-orders.html">Orders</a>
                    </li>
                    <li>
                        <a class="transition-all text-gray-900 hover:text-primary dark:text-white dark:hover:text-primary"
                            href="#.html">Logout</a>
            ...
            <form class="grid grid-cols-12 gap-y-7 gap-x-5 md:gap-x-6 lg:gap-x-7.5"
                ...
                <div class="col-span-full md:col-span-4">
                    ...
                    <input
                        ...
                        value="{{ old('shipping-first-name', $shippingDetail->first_name ?? '') }}">
                ...
                <div class="col-span-full md:col-span-4">
                    ...
                    <input
                        ...
                        value="{{ old('shipping-first-name', $shippingDetail->last_name ?? '') }}"
                ...
                <div class="col-span-full md:col-span-4">
                    ...
                    <input
                        ...
                        value="{{ old('shipping-first-name', $shippingDetail->email ?? '') }}"
