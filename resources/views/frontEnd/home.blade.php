<x-main>
    ...
    <div class="relative h-[360px] w-full overflow-hidden sm:h-[420px] md:h-[440px] lg:h-[540px] xl:h-[640px]">
        ...
        <img class="absolute left-1/2 z-[6] hidden -translate-x-[103%] lg:block"
            src="assets/img/str2/samples/hero-character.png" alt="">

        <div
            class="left-0 top-0 block h-full w-full bg-[url('../../../assets/img/str2/samples/hero-bg.jpg')] bg-cover bg-center bg-no-repeat opacity-10 dark:opacity-100">
                                ...
                                <div>
                                    <div class="mb-4">
                                        ...
                                        <svg role="img" class="aspect-square w-[50px] fill-primary">
                                            <use
                                                xlink:href="{{ asset('assets/img/str2/sprite.svg#' . $gear->tag) }}">
                                            </use>
                                        </svg>
                                    </div>
                    ...
                    <div class="grid gap-5 md:gap-6 lg:gap-7.5">
                        ...
                        <div class="bg-gray-50 p-6 dark:bg-gray-700 md:p-7 lg:p-8">
                            ...
                            <div
                                ...
                                unboxing video!
                                <p><img src="assets/img/str2/samples/twitter-img-1.jpg" alt=""></p>
